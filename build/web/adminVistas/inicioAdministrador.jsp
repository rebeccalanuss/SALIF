<%-- 
    ...
    Created on : 10/06/2019, 11:32:44 PM
    Author     : BELTRAN PC
--%>
            ...
            <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="buttons.html">Altas</a>
                            <a class="collapse-item" href="cards.html">Bajas</a>
                            <a class="collapse-item" href="cards.html">Consultas</a>
                            <a class="collapse-item" href="cards.html">Modificación</a>
                            <a class="collapse-item" href="cards.html">Generación de padrones</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities1" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Lista de opciones:</h6>
                            <a class="collapse-item" href="buttons.html"> Impresión de tarjetones</a>
                            <a class="collapse-item" href="cards.html">Reporte de tarjetones</a>
                            <a class="collapse-item" href="cards.html">Visualizar tarjetón</a>
                            <a class="collapse-item" href="cards.html"> Impresión de tarjetones</a>
                            <a class="collapse-item" href="cards.html">Cancelación de tarjetones</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Lista de opciones:</h6>
                            <a class="collapse-item" href="buttons.html">Generar orden de pago</a>
                            <a class="collapse-item" href="cards.html">Abonar pagos</a>
                        </div>
                    </div>
                </li>
